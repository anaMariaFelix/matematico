...
public interface EmailControllerDocs {
    ...
    ResponseEntity<String> sendEmail(EmailRequestDTO emailRequestDTO); //envia email simples
    ...
    ResponseEntity<String> sendEmailWithAttachment(String emailRequestJson, MultipartFile multipartFile);//envia email com anexo
}
